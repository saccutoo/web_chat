export const URL_PATHS = {
  ...
  //search user
  SEARCH_USER: '/api/user/search-user',
  ...
  REQUEST_TO_USER: '/api/user/get-user-by-id',
  ...
  UPDATE_STATUS_VIDEO_CALL: 'api/videocall/status-video-call',
  // UPDATE_STATUS_VIDEO_CALL: '/messengers/updateStatusVideoCall',
  MESSAGE: '/messengers',
  CHAT_INFO: '/chats/infoChat',
  // REMOVE_GROUP: '/users/removeUser',
  REMOVE_GROUP: '/api/chat-room-member/delete-user-in-chat-room',
  // ADD_MEMBERS: '/chats/addMembers',
  ADD_MEMBERS: '/api/chat-room-member',
};
