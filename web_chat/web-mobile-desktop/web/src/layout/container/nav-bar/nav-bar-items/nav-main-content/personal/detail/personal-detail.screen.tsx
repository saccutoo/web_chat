...
import PersonalDetailAdapter from './personal-detail.adapter';
...
function PersonalDetailScreen(props: any) {
  ...
  /**
   * hungdm - Điều hướng về tin nhắn riêng vs user truyền vào
   * @param user_id 
   * @returns 
   */
  ...
  /**
   * hungdm - Điều hướng về video call vs user truyền vào
   * @param user_id 
   * @returns 
   */
